...
The patients received life saving treatment if necessary, but sometimes it is best to not intervene with surgery and
just monitor the TBI and let the brain heal itself. When TBI patients arrived at HMC, a research coordinator screened
them for the inclusion criteria. If they had an injury the team is interested in, then the coordinator asked them or
their family for consent. A sonographer then used a Terason device in the hospital room to collect ultrasound data.
Data could come from patients hours after an injury or days after an injury. Data collection happened after the patients
were diagnosed using CT or MRI, and did not interfere or interrupt routine hospital clinical care.
...
Patients are distingushed by three-digit numbers.

\begin{figure}
  \centering
  \includegraphics[width=1\linewidth]{figures/ultrasound_angle.png}
  \caption{The orientations at which ultrasound data are collected: left or right side of the head and at axial, coronal, or oblique
  (source: the team's sonographer).}
  \label{ultrasound_angle}
\end{figure}

\section{Signal Processing}

Signal processing is not in the scope of my project. It was done by a scientist in the team, Dr. John Kucewicz.


\section{Existing System}
Talk about Caren's work.

The previous work uses the data in a different way and there was no clear indication that anything was working.
The reported results were poor and the model did not seem to learn anything useful.
